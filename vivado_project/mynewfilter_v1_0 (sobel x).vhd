...
sobel_horizontal_inst : FIR_Horizontal 
port map (
    clk=>s00_axis_aclk,
...
sobel_vertical_inst : FIR_vertical 
port map (
    clk=>s00_axis_aclk,
    rst=>s00_axis_aresetn,
    run=>run,
...
data_sobel<=STD_LOGIC_VECTOR((sobel_out_signed_vertical/8)+128);
